 ...
 * @author daneelolivaw
 */
public class ConverterAccess extends AbstractConverter implements IConverter {

    public ConverterAccess(int dbSourceType){
        super(dbSourceType);
    }
    ...
    protected void definePrimaryKey(ITableVO tableVO,List<DBMetaFieldVO> PKList) {
        ...
        */
        ...
        if(PKList.size() == 1){
            ...
            primaryKey.append(" CREATE INDEX ON(");
            primaryKey.append(PKField.getFieldName());
            primaryKey.append(") WITH PRIMARY; */");
        ...
        // TODO : même cas que les FK !
           ...
           System.out.println("Définition d'une clé primaire sur plus d'une colonne.");
        }
    ...
    protected void defineForeignKeys(ITableVO tableVO,List<DBMetaFieldVO> FKList) {
        // on ne fait rien...
        System.out.println("Conversion vers Access - Pas de clés étrangères");
    }
