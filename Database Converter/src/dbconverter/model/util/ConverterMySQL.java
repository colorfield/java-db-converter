 ...
 * @author daneelolivaw
 */
public class ConverterMySQL extends AbstractConverter
                            implements IConverter {

    
    public ConverterMySQL(int dbSourceType){
        super(dbSourceType);
    }


    // les boucles sur la métabase et les tables se font dans la classe abstraite
    // ici, nous pouvons gérer les spécificités propres à chaque SGDB
    // en construisant une String qui sera ensuite exécutée par l'objet DBReadDump
    ...
    protected DBMetaFieldVO manageFieldSpecificities(DBMetaFieldVO fieldToConvertVO,
        ...
        */
        ...
        if(convertedFieldVO.getFieldDataType().equals("VARCHAR")
            ...
            convertedFieldVO.setFieldDataType("TEXT");
        }
    ...
    protected void writeOpenTableStructure(ITableVO tableVO) {
        ...
        String openTable = "CREATE TABLE IF NOT EXISTS "+tableVO.getTableName()+" (\n";
